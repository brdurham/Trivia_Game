...
{ 1: ['How many players are there in a standard curling team?','Four', 'four', '4', 'FOUR'],
2: ['How many squares are there on the traditional "Snakes & Ladders" board?','100', 'hundred', 'a hundred', 'one hundred'],
3: ['A person who starts fires maliciously is known as a what?','Arsonist', 'arsonist', 'ARSONIST', 'Arson-ist'],
4: ['Where were police dogs first used?','Belgium', 'belgium', 'BELGIUM', 'Bel gium'],
5: ['Ham is taken from what part of a pig?','Hind Leg', 'Hind leg', 'hind leg', 'the hind leg'],
6: ['Alphabetically, which is the last of Santas reindeers?','Vixen', 'vixen', 'Vix-en', 'Vixen the reindeer'],
7: ['Is it true that the Special Sauce on a Big Mac is Thousand Island Dressing?','No', 'no', 'false', 'False'],
8: ['What sport would you be playing if the score was deuce?','Tennis', 'tennis', 'TENNIS', 'austins sport'],
9: ['What is the name for Germanys high-speed highways?','Autobahn', 'autobahn', 'The autobahn', 'AUTOBAHN'],
10:['Mageirocophobia is a fear of what?','Cooking', 'cooking', 'fear of cooking', 'COOKING'] }
